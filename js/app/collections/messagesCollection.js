 ...
 */
define(['..', '../models/messagesModel', 'backbone', 'underscore', 'nrm-ui'],
    function(Suds, messagesModel, Backbone, _, Nrm) {
        return Suds.Collections.messagesCollection =
            Backbone.Collection.extend(/** @lends module:app/collections/specialUseTaskCollection.prototype */{
                     ...
                     */
                    url: messagesModel.prototype.urlRoot,
                    /**
