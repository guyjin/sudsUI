 ...
 */
define(['..', '../models/specialUseTask', 'backbone', 'underscore', 'nrm-ui'],
        function(Suds, SpecialUseTask, Backbone, _, Nrm) {
    return Suds.Collections.SpecialUseTaskCollection = 
         ...
         */
        url: SpecialUseTask.prototype.urlRoot,
        /**
    ...
    /** @lends module:app/collections/specialUseTaskCollection */{
        /**
         * Array of sort attributes.  For each object in the array, "prop" is the model attribute or name of a prototype 
         * function to sort on, and desc indicates that we should use a descending sort instead of ascending.
         * @type {Object[]}
         */
        sortAttr: [
            {prop: 'stageIndex'}, 
            {prop: 'priority', desc: true}, 
            {prop: 'name'}
        ]
    });
});