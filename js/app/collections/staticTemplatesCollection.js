 ...
 */
define(['..', '../models/staticTemplateModel', 'backbone', 'underscore', 'nrm-ui'],
    function(Suds, StaticTemplateModel, Backbone, _, Nrm) {
        return Suds.Collections.StaticTemplateCollection =
            Backbone.Collection.extend(/** @lends module:app/collections/specialUseTaskCollection.prototype */{
                    ...
                    url: "api/uiTest/staticTemplates",
                    /**
