define(['nrm-ui/views/panelView', "jquery",
    ...
    "app/views/contactsManagement/contactsManagementPanelView",
    "hbs!contacts/contactFormAddedNumPill", "hbs!contacts/contactFormAddressPill"], function(PanelView, $, Nrm, _,require,
                                                      Backbone,ContactsManagementPanelView,ContactFormAddedNumPill,ContactFormAddressPill) {
    ...
    return ContactsManagementPanelView.extend({
        ...
        modelEvents: $.extend({}, ContactsManagementPanelView.prototype.modelEvents, {
            'change' : "modelChange",
        ...
        getContactContentSectionControls : function (formType) {
            ...
            if(formType === 'SolePropr'){
                var businessNameControl = this.getFieldSetControl("businessName", "businessName", this.getBusinessNameFieldsetControls());
                controls.splice(1, 0, businessNameControl);
            }
      ...
      /*  businessNamePanelControls: function() {
            var businessNamePanelControls = [
                {
                    id: 'businessNameContainer',
                    type: 'contacts/inputContainer',
                    //group:true,
                    //groupContainerClasses : 'form-group',
                    controls: [{
                        id: 'phoneNumberType',
                        type: 'text',
            ...
            return businessNamePanelControls;
        },*/
        ...
        applyPlugin: function(parent, c, callback) {
            ...
            return ContactsManagementPanelView.prototype.applyPlugin.apply(this, arguments) ;
        },
        /**
