define(['nrm-ui/views/panelView', "jquery",
    ...
    "app/views/contactsManagement/addNewForms/contactFormView",
    "hbs!contacts/contactFormAddedNumPill", "hbs!contacts/contactFormAddressPill"], function(PanelView, $, Nrm, _,require,
                                                      Backbone,ContactFormView,ContactFormAddedNumPill,ContactFormAddressPill) {

    return ContactFormView.extend({
