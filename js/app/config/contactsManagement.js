define({
    "modules": {
        "model": "app/models/contactManagement/contactModel",
        "collection": "app/collections/contactManagement/contactCollection",
        /*"model": "app/models/common/recordModel",
        "collection": "app/collections/recordCollection",*/
        "editor": "app/views/contactsManagement/contactsManagementView"
        // ,"search": "app/views/specialUseProcessSearchView"
    },
    "caption": "Contact Management", // folder node label (also used other places, e.g. generic quick search title, error messages)
    "alias": "Contact Management", // user-friendly display name, also model name with any non-word characters removed if "modelName" not specified.
    "modelName" : "ContactModel",
    "topLevel": false, // show at the top level in the tree
    "nameAttr": "contactCn", // model attribute name to use for tree node label
    "loadRules": false,
    "loadType": "search", // load automatically instead of waiting for a search
    //"groupAttr": "category", // nodes will be grouped into folders derived from distinct values of this model attribute

    "idAttr": "contactCn", // if using a generated model with id attribute other than "id"
    ...
    "searchResults": {
        ...
        "columns":  [ // colums to display in grid, can also be a config object for each column
            ...
            {
                prop: "authorizationCn",
                label: "Authorization CN"
            }
            //     "statusDate"
        ]
        ,"actions": [
