define({
    "modules": {
        "model": "app/models/common/workflowTestModel",
        "collection": "app/collections/workflowTestCollection",
        "editor": "app/views/common/specialUseRecordTestView",
        /*"results": "app/views/specialUseTestResultView"*/
    },
    "caption": "Direct Screen Test", // folder node label (also used other places, e.g. generic quick search title, error messages)
    "alias": "Direct Screen Test", // user-friendly display name, also model name with any non-word characters removed if "modelName" not specified.
    "modelName" : "RecordTestModel",
    "topLevel": true, // show at the top level in the tree
    "nameAttr": "value", // model attribute name to use for tree node label
    "loadRules": false,
    ...
    "idAttr": "id", // if using a generated model with id attribute other than "id"
