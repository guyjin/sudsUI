define({
    "modules": {
        "model": "app/models/common/recordTestModel",
        "collection": "app/collections/recordTestCollection",
        "editor": "app/views/common/specialUseRecordTestView",
        /*"results": "app/views/specialUseTestResultView"*/
    },
    "caption": "Steps", // folder node label (also used other places, e.g. generic quick search title, error messages)
    "alias": "Steps", // user-friendly display name, also model name with any non-word characters removed if "modelName" not specified.
