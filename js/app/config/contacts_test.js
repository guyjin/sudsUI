define({
    "modules": {
        "model": "app/models/common/contactsModel",
        "collection": "app/collections/contactsCollection",
        "editor": "app/views/common/contactEditorView",
        "results": "app/views/contactsView"
    },
    "caption": "Contacts Management", // folder node label (also used other places, e.g. generic quick search title, error messages)
    "alias": "Contacts", // user-friendly display name, also model name with any non-word characters removed if "modelName" not specified.
    "modelName" : "Contacts",
