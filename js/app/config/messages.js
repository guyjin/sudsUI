define({
    "modules": {
        "model": "app/models/messagesModel",
        "collection": "app/collections/messagesCollection",
        "editor": "app/views/messagesView"
    },
    "caption": "Hello Messages", // folder node label (also used other places, e.g. generic quick search title, error messages)
    "alias": "Message", // user-friendly display name, also model name with any non-word characters removed if "modelName" not specified.
    ...
    "idAttr": "introCN", // if using a generated model with id attribute other than "id"
    ...
    "disableNew": false, // shortcut for disabling the "New {Item}" context menu item
