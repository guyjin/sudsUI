define({
    "modules": {
        ...
        "editor": "app/views/common/specialUseRecordView"
        // ,"search": "app/views/specialUseProcessSearchView"
    },
    "caption": "Proposals", // folder node label (also used other places, e.g. generic quick search title, error messages)
    "alias": "Proposal", // user-friendly display name, also model name with any non-word characters removed if "modelName" not specified.
    "modelName" : "RecordModel",
    "topLevel": true, // show at the top level in the tree
    "nameAttr": "authorizationId", // model attribute name to use for tree node label
    "loadRules": true,
    ...
    "idAttr": "authorizationCn", // if using a generated model with id attribute other than "id"
