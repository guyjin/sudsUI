define({
    "modules": {
        "model": "app/models/common/staticTemplateModel",
        "collection": "app/collections/staticTemplatesCollection",
        "editor": "app/views/staticTemplateView",
        /*"results": "app/views/specialUseTestResultView"*/
    },
    "caption": "Static Templates", // folder node label (also used other places, e.g. generic quick search title, error messages)
    "alias": "Static Templates", // user-friendly display name, also model name with any non-word characters removed if "modelName" not specified.
    ...
    "idAttr": "value", // if using a generated model with id attribute other than "id"
